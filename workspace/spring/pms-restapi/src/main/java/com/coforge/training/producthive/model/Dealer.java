...
public class Dealer {
	...
	@Size(min=8, max=255, message="Passward must be between 8 to 255 characters")
	...
	public Dealer(Long id, String email, String fname, String lname,
			@NotBlank(message = "Password can't be blank") @Size(min = 8, max = 255, message = "Passward must be between 8 to 255 characters") String password,

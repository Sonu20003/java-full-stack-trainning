...
public class JoinDemo2 {
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("--------------------------------------------------------------------------------------------------");
			System.out.printf("%-10s %-10s %-10s %-15s %-12s %-15s %-5s%n","Emp ID","First name","Last name", "DOB", "Status","DESC","Dept ID");
			System.out.println("--------------------------------------------------------------------------------------------------");
			...
			while (rs.next()) {
				...
				System.out.printf("%-10s %-10s %-10s %-15s %-12s %-15s %-5s%n", empId, firstName, lastName, dob, status, dsc, dId);

...
(9999, 'Sonu Sharma', 'Sharma', 'Sonu', '9998882222', 'Square Streets','Bikini Bottom', 'Bhimtal', 'Uttarakhand', 'xxxx36','India', NULL, 500000);


SELECT * FROM customersbackup2025 WHERE customerNumber = 9999;
